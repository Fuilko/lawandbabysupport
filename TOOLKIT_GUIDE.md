...
### 🔴 緊急 — 立證に必要（まだ確認できていないもの）

| # | 必要資訊 | 用途 | 入手方法 |
|---|---------|------|---------|
| 1 | **威脅斷貨のメール/通話記録** | 優越的地位濫用の立証 | メールボックス/通話アプリから抽出 |
| 2 | **あなたの事業計画書** | 逸失利益の算定基礎 | 作成 or 既存文書 |
| 3 | **受注済み/見込み契約の証拠** | 逸失利益の具体的金額 | 顧客（梁氏等）からの証明 |
| 4 | **1年間の経費明細 (領収書)** | 直接投入コストの立証 | 経理記録 |
| 5 | **あなたの時間単価の根拠** | 人件費算定 | 大学の研究員報酬 or 測量業の相場 |
| 6 | **車両修理の見積書/領収書** | 物的損害の立証 | 修理工場 |
| 7 | **台湾出張の全領収書** | 出張費用の立証 | 航空券、宿泊、交通 |

### 🟡 重要 — あると強化されるもの

| # | 必要資訊 | 用途 | 入手方法 |
|---|---------|------|---------|
| 8 | **M4-0 の広告・販促資料** | 「山岳林業用」と謳っていた証拠 | Mapry HP (スクショ保存)、パンフ |
| 9 | **Mapry 他ユーザーの事故情報** | 製品の系統的欠陥を示す | ネット検索、業界人脈 |
| 10 | **PL保険の有無確認** | 回収手段の確保 | ADR で相手方に確認要求 |
| 11 | **農水省 SBIR 採択リストの確認** | 補助金問題の立証 | 農水省 HP or 情報公開請求 |
| 12 | **34項目の欠陥リスト (完全版)** | 現在のフォレンジック報告は18項目。残り16項目は？ | あなたの分析 |
| 13 | **顧客の陳述書 (梁氏等)** | 事故の第三者証言 | 梁氏に依頼 |

### 🟢 nice-to-have — 追加搜尋すべき判例

| # | 搜尋キーワード | 理由 |
|---|-------------|------|
| 14 | 「詐欺 + 製品」 | 詐欺的販売の判例 |
| 15 | 「優越的地位濫用 + 断貨」 | 取引拒絶の判例 |
| 16 | 「逸失利益 + 立証」 | 逸失利益算定の判例 |
| 17 | 「ソフトウェア + 欠陥 + PL法」 | ソフトウェア組込み製品の PL 判例 |
| 18 | 「ドローン + 事故 + 損害賠償」 | ドローン事故の損害算定 |
